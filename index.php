        ...
        <div class="row bg-secondary py-1 px-xl-5">
            <div class="col-lg-6 d-none d-lg-block">
                <div class="d-inline-flex align-items-center h-100">
                    ...
                    <a class="text-body mr-3" href="https://wa.me/62895341303880">Contact</a>
        ...
        <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
            <div class="col-lg-4">
                <a href="" class="text-decoration-none">
                    ...
                    <span class="h1 text-uppercase text-dark bg-white px-2 ml-n1">Rumah</span>
                </a>
            </div>
            <div class="col-lg-4 col-6 text-left">
                <form action="">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="Cari Rumah">
            ...
            <div class="col-lg-4 col-6 text-right">
                <a class="m-0" href="https://wa.me/62895341303880">Customer Service</a>
            </div>
        </div>
    </div>
    <!-- Topbar End -->
                    ...
                    <div class="navbar-nav w-100">
                        <div class="nav-item dropdown dropright">
                            ...
                            <div class="dropdown-menu position-absolute rounded-0 border-0 m-0">
                                ...
                                <a href="" class="dropdown-item">Rumah Mahal</a>
                            </div>
                        </div>
                        <div class="nav-item dropdown dropright">
                        ...
                        <a href="" class="nav-item nav-link">Kos-kosan</a>
                    </div>
                </nav>
            </div>
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    <a href="" class="text-decoration-none d-block d-lg-none">
                        <span class="h1 text-uppercase text-dark bg-light px-2">Ada</span>
                        <span class="h1 text-uppercase text-light bg-dark px-2 ml-n1">Rumah</span>
                    </a>
        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-4">
                <div class="product-offer mb-30" style="height: 200px;">
                    <img class="img-fluid" src="img/rumahmurah2.jpeg" alt="">
                    <div class="offer-text">
                        <h6 class="text-white text-uppercase">Diskon 10%</h6>
                        <h3 class="text-white mb-3">Special Offer</h3>
                        <a href="" class="btn btn-primary">Beli</a>
                    </div>
                </div>
                <div class="product-offer mb-30" style="height: 200px;">
                    <img class="img-fluid" src="img/rumahmewah2.jpg" alt="">
                    <div class="offer-text">
                        <h6 class="text-white text-uppercase">Bonus Isi Rumah</h6>
                        <h3 class="text-white mb-3">Special Offer</h3>
                        <a href="" class="btn btn-primary">Beli</a>
                    </div>
                </div>
        ...
        <div class="row px-xl-5 pb-3">
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="d-flex align-items-center bg-light mb-4" style="padding: 30px;">
                    ...
                    <h5 class="font-weight-semi-bold m-0">Terpercaya</h5>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="d-flex align-items-center bg-light mb-4" style="padding: 30px;">
                    <h1 class="fa fa-shipping-fast text-primary m-0 mr-2"></h1>
                    <h5 class="font-weight-semi-bold m-0">Perpindahan Mudah</h5>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="d-flex align-items-center bg-light mb-4" style="padding: 30px;">
                    <h1 class="fas fa-exchange-alt text-primary m-0 mr-3"></h1>
                    <h5 class="font-weight-semi-bold m-0">Pembayaran Mudah</h5>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="d-flex align-items-center bg-light mb-4" style="padding: 30px;">
                    <h1 class="fa fa-phone-volume text-primary m-0 mr-3"></h1>
                    <h5 class="font-weight-semi-bold m-0">24/7 Bantuan</h5>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row px-xl-5 pb-3">
                ...
                <a class="text-decoration-none" href="">
                    <div class="cat-item d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                            <img class="img-fluid" src="photos/rumahmurah1.jpg" alt="">
                        </div>
                        <div class="flex-fill pl-3">
                            <h6>Rumah Murah</h6>
                            <small class="text-body">3 Rumah</small>
                        </div>
                    </div>
                </a>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href="">
                    <div class="cat-item img-zoom d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                            <img class="img-fluid" src="photos/rumahsedang2.jpg" alt="">
                        </div>
                        <div class="flex-fill pl-3">
                            <h6>Rumah Mahal</h6>
                            <small class="text-body">3 Rumah</small>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href="">
                    <div class="cat-item img-zoom d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                            <img class="img-fluid" src="photos/rumahmewah4.jpg" alt="">
                        </div>
                        <div class="flex-fill pl-3">
                            <h6>Rumah Mewah</h6>
                            <small class="text-body">4 Rumah</small>
                        </div>
                    </div>
                </a>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href="">
                    <div class="cat-item img-zoom d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                            <img class="img-fluid" src="photos/kontrakan1.jpg" alt="">
                        </div>
                        <div class="flex-fill pl-3">
                            <h6>Kontrakan</h6>
                            <small class="text-body">8 Rumah</small>
                        </div>
                    </div>
                </a>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href="">
                    <div class="cat-item img-zoom d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                            <img class="img-fluid" src="photos/kos-kosan1.jpg" alt="">
                        </div>
                        <div class="flex-fill pl-3">
                            <h6>Kos-kosan</h6>
                            <small class="text-body">16 Kamar</small>
                        </div>
                    </div>
                </a>
            </div>
    ...
    <div class="container-fluid pt-5 pb-3">
        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <div class="product-item bg-light mb-4">
                    <div class="product-img position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="photos/rumahmurah2.jpeg" alt="">
                        <div class="product-action">
                            <a class="btn btn-outline-dark btn-square" href=""><i class="fa fa-shopping-cart"></i></a>
                            <a class="btn btn-outline-dark btn-square" href=""><i class="far fa-heart"></i></a>
                            <a class="btn btn-outline-dark btn-square" href=""><i class="fa fa-sync-alt"></i></a>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <div class="product-item bg-light mb-4">
                    <div class="product-img position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="photos/rumahmurah3.jpeg" alt="">
                        <div class="product-action">
                            <a class="btn btn-outline-dark btn-square" href=""><i class="fa fa-shopping-cart"></i></a>
                            <a class="btn btn-outline-dark btn-square" href=""><i class="far fa-heart"></i></a>
                            <a class="btn btn-outline-dark btn-square" href=""><i class="fa fa-sync-alt"></i></a>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <div class="product-item bg-light mb-4">
                    <div class="product-img position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="photos/rumahsedang1.jpg" alt="">
                        <div class="product-action">
                            <a class="btn btn-outline-dark btn-square" href=""><i class="fa fa-shopping-cart"></i></a>
                            <a class="btn btn-outline-dark btn-square" href=""><i class="far fa-heart"></i></a>
                            <a class="btn btn-outline-dark btn-square" href=""><i class="fa fa-sync-alt"></i></a>
        ...
        <div class="row border-top mx-xl-5 py-4" style="border-color: rgba(256, 256, 256, .1) !important;">
            <div class="col-md-6 px-xl-0">
                <p class="mb-md-0 text-center text-md-left text-secondary">
                    &copy; <a class="text-primary" href="index.html">AdaRumah</a>. All Rights Reserved. Designed
                    by
                    <a class="text-primary" href="https://www.instagram.com/robertdrl_">Robertdrl</a>
                    <br>Distributed By: <a href="#" target="_blank">Tim 8</a>
                </p>
            </div>
