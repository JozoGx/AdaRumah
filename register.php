...
<body>
    ...
    <div class="container-fluid">
        <h2 class="section-title position-relative text-center"><span class="bg-secondary pr-3">Register</span></h2>
        <div class="row px-xl-5 d-flex justify-content-center align-items-center">
            <div class="col-lg-7 mb-5">
                <div class="contact-form bg-light p-30">
                    ...
                    <form action="service/action/register.php" method="post" name="register" id="register">
                        <!-- email -->
                        ...
                        <div class="control-group">
                            <input type="text" class="form-control" id="name" name="name"
                                ...
                                data-validation-required-message="Enter a Nickname" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div>
                            <button type="submit" name="register" class="btn btn-primary py-2 px-4">Register</button>
                        </div>
                    </form>
                </div>
            </div>
